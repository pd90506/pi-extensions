# Intent and Plan Policy Draft

Candidate content for `~/.pi/agent/APPEND_SYSTEM.md`.
...
### Required behavior
For Tier 3:
1. You may perform limited read-only exploration first if it helps clarify context.
2. Do not modify files before user approval.
3. After exploration, respond with an inline plan and wait for approval.
4. Do not continue into implementation in the same turn.
